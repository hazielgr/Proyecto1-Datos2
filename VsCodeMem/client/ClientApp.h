 ...
 * @version 2.0
 */
#ifndef VSCODEMEM_CLIENTAPP_H
#define VSCODEMEM_CLIENTAPP_H
...
public:
    ...
    */
    ...
    void sendList(LinkedList<string> listToSend);
    void sendList(LinkedList<bool> listToSend);
    void sendList(LinkedList<int> listToSend);
...
protected:
    ...
    bool isThisSerializable(const char *msg);
};
